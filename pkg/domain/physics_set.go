...
func (ss *PhysicsSet) encodeName(name string, limit int) string {
	// Encode to CP932
...
// 物理ボーンだけ残す
func (ss *PhysicsSet) GetOutputMotionOnlyPhysics(startFrame, endFrame float64) (*vmd.VmdMotion, error) {
